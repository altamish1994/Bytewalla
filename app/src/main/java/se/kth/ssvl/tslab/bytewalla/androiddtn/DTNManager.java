...
import se.kth.ssvl.tslab.bytewalla.androiddtn.servlib.discovery.AcceptThread;
...
public class DTNManager extends Activity  {
	...
	//arrays for storing contact names and eids
	public static ArrayList<String> contactName=new ArrayList<String>();
	public static ArrayList<String> contactEid=new ArrayList<String>();;
...
//		try {
//			m.sendMessage("Hello ALti","dtn://020000000000.bytewalla.com/");
	...
	private void init_buttons() {
		...
		startStopButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (DTNService.is_running()) {
					...
					BluetoothDiscovery.init(DTNManager.this);
					acceptThread= new AcceptThread(DTNManager.this, BluetoothAdapter.getDefaultAdapter(),null,null);
		...
		resetStorageButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				MultiHopStorage.getInstance().reset_storage();
