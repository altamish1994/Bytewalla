...
public class DTNBundleSpec{
	...
	public int getSec_bundle_id() {
		return sec_bundle_id;
	}

	public void setSec_bundle_id(int sec_bundle_id) {
		this.sec_bundle_id = sec_bundle_id;
	}

	/**
	 * Actual destination for Multi Hop
	 */
	private int sec_bundle_id;
	/**
	 * Actual destination for Multi Hop
	 */
	private DTNEndpointID act_dest;
	 ...
	 */
	public DTNEndpointID act_dest() {
		return act_dest;
	}
	public void set_actual_des(DTNEndpointID des) {
		act_dest = des;
	}
