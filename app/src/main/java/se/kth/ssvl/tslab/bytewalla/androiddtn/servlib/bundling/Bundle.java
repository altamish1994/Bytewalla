...
public class Bundle implements Serializable {
	...
	public final void set_act_dest(EndpointID dest) {
		act_dest = dest;
	}
	...
	public final EndpointID act_dest() {
		return act_dest;
	}
